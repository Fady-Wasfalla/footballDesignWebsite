...
function SubstitutionNoPhoto() {
  ...
  return (
    ...
    <Card.Header style={{backgroundColor:"#0169d9",fontSize:"30px"}}>Substitution (No photos)</Card.Header>
    <Col md={12}>
...
export default SubstitutionNoPhoto;
